...
class RiskMetricsPeriod(object):
    ...
    def calculate_metrics(self):
        ...
        self.algorithm_covariance = self.calculate_algorithm_covariance()
        self.benchmark_variance = self.calculate_benchmark_variance()
        self.condition_number = self.calculate_condition_number()
        self.eigen_values = self.calculate_eigen_values()
